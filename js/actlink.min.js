...
$(document).ready(function(){
  ...
  $('.sidebar ul.nav-sidebar').on('click', 'li[data-id^="internal-bookmarks"]', function(e) {
		...
		if(typeof OCA.Files != 'undefined' && OCA.Files.App != 'undefined'){
			...
			window.location.href = "/index.php/apps/files?dir="+$(this).attr('data-path')+"&view=bookmark&data-id="+
			$(this).attr('data-id')+"&data-file_id="+$(this).attr('data-file_id')+"&data-owner="+
			$(this).attr('data-owner')+"&data-group="+$(this).attr('data-group');
		}
	});
