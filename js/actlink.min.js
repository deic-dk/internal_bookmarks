		...
		success: function(response) {
			if(response){
				...
				$.each( response, function(key,value) {
					bookmarks = bookmarks+'<li data-id="internal-bookmarks_'+value.bkid+'" data-path="'+value.bktarget+'"><a href="#"><i class="icon icon-folder deic_green"></i><span>'+value.bktitle+'</span></a></li>';
				});
				...
				if($('ul.nav-sidebar li#places span i.icon-angle-right').is(':visible')){
					$('ul.nav-sidebar li[data-id^="internal_bookmarks"]').hide();
				}
			}
		}
  });
